...
Description: Fixes problems that prevent installing or upgrading WordPress, themes, and plugins on some Pure-FTPd server configurations. A permanent patch is planned for WordPress 3.2 and this plugin should be obsolete after upgrading to that version. To get started: 1) Click the "Activate" link to the left of this description, 2) Upgrade WordPress, themes, or plugins through the WordPress admin.
Version: 1.0
Author: John Ford
